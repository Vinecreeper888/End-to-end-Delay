...
#end to end delay
def endtoendDelay(n,transDelay,propDelay):
	return n*(transDelay + propDelay)

def main():
	t1,t2,d1,d2,N,n,M,S,p = 1,1,1,1,1,1,1,1,1 #Default
	try:
	...
	while n<=N:
		...
		n = n + 1
		A = A + transDelay(t1,M)
	print ("\nEnd to End transmission delay = {0} ms\n".format(B))
def printHelp():
